  ...
  public: {
    Tables: {
      analytics_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "analytics_logs_business_id_fkey"
            columns: ["business_id"]
            isOneToOne: false
      ...
      demand_predictions: {
        ...
        Relationships: [
          {
            foreignKeyName: "demand_predictions_business_id_fkey"
            columns: ["business_id"]
            isOneToOne: false
            referencedRelation: "businesses"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      is_business_admin: { Args: { _user_id: string }; Returns: boolean }
    }
    Enums: {
